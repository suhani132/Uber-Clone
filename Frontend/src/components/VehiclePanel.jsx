  ...
  return (
    <div>
      <h5 onClick={()=>{
       ...
       className="p-1 text-center w-[93%] absolute top-0 "><i className=" text-gray-400 text-3xl ri-arrow-down-wide-line"></i></h5>
      ...
      <div className= "ml-2 w-1/2">
        ...
        <h2 className="font-semibold text-lg"> ₹193.56</h2>
      </div>
      ...
      <div  onClick={()=>{
        ...
        <h2 className="font-semibold text-lg"> ₹63.60</h2>
      </div>
      ...
      <div onClick={()=>{
        ...
        <h2 className="font-semibold text-lg"> ₹118.30</h2>
      </div>
    </div>
  )
}
